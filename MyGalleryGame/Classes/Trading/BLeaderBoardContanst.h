...
//Key for Parse
static const string appID="X-Parse-Application-Id: NowxMMqQy41HIZfgtSPK6fqSvxJGr2PS3XxwWHjf";
static const string restAPI="X-Parse-REST-API-Key: D1IPNshGLcQTRmnwktdjFnyyJsnTFppBvskPGpLr";
